import { Box, Button, Grid, HStack, Heading, Image, Table, TableCaption, TableContainer, Tbody, Td, Th, Thead, Tr, VStack, useDisclosure } from '@chakra-ui/react'
...
function Row({ item, courseDetailsHandler, deleteButtonHandler }) {
    return (
        <Tr>
            <Td>#{item._id}</Td>
            <Td>{item.title}</Td>
            <Td><Image src={item.poster.url} alt={item.title} /></Td>
