...
import { addToCart, checkout, clearCart, getCart, placeOrder, removeFromCart } from '../../redux/actions/cartAction';
import './Cart.css';
                                ...
                                <tr key={item._id} className="cart-item">
                                    ...
                                    <td className="col-item">
                                        <div className='quantity-container'>
                                            <button className="btn-primary" onClick={(e) => removeFromCartHandler(e, item.courseId)}>-</button>
                                            <strong> {item.quantity}</strong>
                                            <button className="btn-primary" onClick={(e) => addToCartHandler(e, item.courseId)}>+</button>
                                        </div>
                                    </td>
                                    <td className='col-item'>₹{item.price * item.quantity}</td>
                                    <td className='col-item'><button className='btn-primary' onClick={() => clearCartHandler(item.courseId)}>Remove</button></td>
                                </tr>
                            ))}
