      ...
      <div className="course-details">
        <div className="course-details-deshboard">
          ...
          <div className="course-description">
            ...
            <p>
              This course has been designed by two professional Data Scientists
              so that we can share our knowledge and help you learn complex
              theory, algorithms, and coding libraries in a simple way. We will
              walk you step-by-step into the World of Machine Learning. With
              every tutorial, you will develop new skills and improve your
        ...
        <div className="course-details-card" key={course._id}>
          ...
          <div className="card-details">
            <span>
              <FaTv className="level" /> Lessons
            </span>
            <span>{course.numofVideos} Lessons</span>
          </div>
          <div className="card-details">
            <span>
